...
def get_dataset(config_dataset):
    ...
    if dataset_name == 'RefCOCO':
        ...
        from my_datasets.gqa import GQADataset
        ...
        from my_datasets.okvqa import OKVQADataset
        ...
        from my_datasets.nextqa import NExTQADataset
        dataset = NExTQADataset(**config_dataset)
    elif dataset_name == 'MyDataset':
        from my_datasets.my_dataset import MyDataset
